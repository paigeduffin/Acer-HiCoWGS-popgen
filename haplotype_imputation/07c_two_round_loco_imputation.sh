...
# Usage: bash 07c_two_round_loco_imputation.sh [LOCO_330.vcf.gz] [COMBINED_REFERENCE.fa] [REFERENCE_DIR] [GENETIC_MAP] [NEW_OUTPUT_DIRECTORY]
...
LOCO_VCF=${1:-loco_variant_calling/LoCo_plus_DRTO102_merge.vcf.gz}
COMBINED_REFERENCE=${2:-ref_genome_indexed/GCA_964034985.1_Acer_S.fitti.fa}
